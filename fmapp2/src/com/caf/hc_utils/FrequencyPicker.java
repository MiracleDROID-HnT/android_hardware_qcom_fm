...
public class FrequencyPicker extends FrameLayout {
    ...
    public FrequencyPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mMHzPicker != null) {
           ...
           mMHzPicker.setBackgroundColor(context.getResources().getColor(R.color.picker_frequency_dialog_mhz_background_color));
        ...
        if (mKHzPicker != null) {
           ...
           mKHzPicker.setBackgroundColor(context.getResources().getColor(R.color.picker_frequency_dialog_khz_background_color));
